...
@section('content')
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <h2 class="text-2xl font-bold mb-6 text-gray-800">Nouvelle Consultation</h2>
            ...
            <form method="POST" action="{{ route('consultations.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="date" type="datetime-local" name="date" value="{{ old('date') }}" class="mt-1 block w-full" required />
                ...
                <div class="mb-4">
                    ...
                    <textarea id="consultation" name="consultation" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('consultation') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="examen" name="examen" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('examen') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="prescription" name="prescription" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('prescription') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="traitement" name="traitement" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('traitement') }}</textarea>
